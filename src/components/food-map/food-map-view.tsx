...
function DetailPanel({
  ...
  const stationMapAvailable = isFoodleStationId(station.id);
  ...
  return (
    <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 rounded-xl bg-muted/55 px-3 py-3 max-[420px]:grid-cols-1">
      ...
      <div className="grid gap-2 max-[420px]:w-full">
        {stationMapAvailable ? (
          <Link
            href={`/food-map/stations/${station.id.toLowerCase()}`}
            className="inline-flex min-h-11 items-center justify-center rounded-lg bg-[#672d7e] px-4 text-sm font-medium text-white outline-none hover:bg-[#542267] focus-visible:ring-3 focus-visible:ring-[#672d7e]/40 dark:bg-[#c48fda] dark:text-[#211225]"
          >
